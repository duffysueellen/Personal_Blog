...
E(incidence_graph)$color <- "lightgray"
...
plot(incidence_graph,     edge.label = NA,
     vertex.label = NA, 
...
legend("bottomright",
       ...
       fill = c("pink", "blue"),   # Fill colors corresponding to vertex colors
